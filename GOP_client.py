...
class MyClient(WebSocketClient):
    ...
    def received_message(self, m):
        ...
        # output hypothese
        with open("/share/nas165/fanjiang/CAPT/data/l2_arctic/eval_result/Librispeech-tdnnf_100hr/test/annotation.txt", "a") as f:
            f.write(self.id)
...
def main():
    ...
    ws = MyClient(args.id, args.audiofile, args.uri + '?%s' % (urllib.urlencode([("content-type", content_type), ("prompt", args.prompt)])), byterate=args.rate,
